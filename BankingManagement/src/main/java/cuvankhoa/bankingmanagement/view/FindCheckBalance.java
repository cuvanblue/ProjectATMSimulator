 ...
 * @author TOTORO
 */
public class FindCheckBalance extends javax.swing.JDialog {
    ...
    public FindCheckBalance(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Find Checkbalance transactions");
        setResizable(false);
        ...
        jScrollPane9.setViewportView(checkBalanceTable);
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        try {
            CheckBalanceTransaction a = new CheckBalanceTransaction("*", "*", "*", "*", -1, "*");
            dtm = (DefaultTableModel)checkBalanceTable.getModel();
            // clear table
